...
export default function Dashboard() {
  ...
  const fetchStats = async () => {
    ...
    const upcomingPoEnds = employees
      .filter((e) => {
        ...
        try {
          ...
          return (
            !isNaN(endDate.getTime()) && endDate > now && endDate <= thresholdDate
          );
        } catch {
          return false;
        }
      ...
      .sort(
        (a, b) =>
          new Date(a.poEndDate).getTime() - new Date(b.poEndDate).getTime()
      );
    ...
    const taskDefinitions = [
      {
        name: 'HR Check-in (12th)',
        day: 12,
        statusField: 'hrCheckin12thStatus',
        pendingStatus: 'Pending',
      },
      {
        name: 'HR Check-in (25th)',
        day: 25,
        statusField: 'hrCheckin25thStatus',
        pendingStatus: 'Pending',
      },
      {
        name: 'Timesheet',
        day: 29,
        statusField: 'timesheetStatus',
        pendingStatus: 'Pending',
      },
      {
        name: 'Invoice',
