...
Return a JSON object containing a 'rankedCandidates' array. Each object in the array must include:
    - rank: The numerical rank, sorted from highest score to lowest.
    - name: The candidate's name.
    - score: The calculated score (1-100).
    - mustHaves: An array of emojis corresponding to each job requirement provided in the input. Use "✅" for Yes, "🟡" for Maybe, and "❌" for No. The order of emojis must match the order of the job requirements.
